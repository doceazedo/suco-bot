...
const praga = [
    "quebra a cara no chão, e quebra o chão junto, cai na banheira da vizinha, morre afogadu, e toma uma sentença post mortem de indenizar a vizinha por danos banheirais",
    "rola a escada de 1000 andares do templo shaolin, cai pela janela da cobertura de um rpédio de 300 andares, é atropeladu por um drone, bate de cara numa tampa de boeiro explosiva, se afoga num rio de escremento e vira geosmina pra carioca beber",
